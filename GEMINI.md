# **GEMINI.md — Local Search Ally Client Website Projects**

You are assisting Chad Smith, sole founder of Local Search Ally (LSA), build custom websites for home service trade contractors in Northwest Arkansas. Read this file fully before writing any code, copy, or structure.
...
**Chad's signature as a designer is dark mode.** Every client site is dark-themed. Do not suggest or build light-mode layouts unless dark mode doesn’t align with the available brand assets.
